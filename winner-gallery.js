(function(){
  ...
  var stateKey='etb2b_awards.gallery.v14';
  ...
  try{var a=JSON.parse(localStorage.getItem('etb2b_awards_new_award')||'null');if(a&&a.name)award=a;}catch(e){}
